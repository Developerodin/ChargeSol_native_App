...
import Asset31 from "../../CarImages/WelocmeScreen/Asset31.png"
import Asset51 from "../../CarImages/WelocmeScreen/Asset51.png"
const slides =[
  {
    id:'1',
    image:Asset21,
...
const Slide = ({item}) => {
  return (
    <View style={{alignItems:"left",marginTop:30,width:width}}>
      ...
      <View style={{alignItems:"left",width:width,alignItems:"left",padding:10}}>
        
        <Text style={{fontSize:18,fontWeight:400,letterSpacing:0.3,lineHeight:25}}>{item?.subtitle}</Text>
      </View>
    </View>
  );
};
